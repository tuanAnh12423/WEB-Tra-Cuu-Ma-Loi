...
function ManualListPage() {
  ...
  return (
    <div style={{ width: "100%", minHeight: "100vh", backgroundColor: "#f5f6fa", padding: "24px 20px", boxSizing: "border-box" }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 20 }}>
          <button 
            onClick={() => navigate(-1)} 
            style={{ background: "#fff", border: "1px solid #d1d5db", padding: "8px 18px", borderRadius: 8, cursor: "pointer", fontWeight: 600, color: "#374151" }}
          >
            ← Quay lại
          </button>
        ...
        <div style={{ position: "relative", marginBottom: 16 }}>
          ...
          <input 
            ...
            style={{ 
              width: "100%", padding: "14px 16px 14px 48px", borderRadius: 12, border: "2px solid #0284c7", 
              outline: "none", fontSize: 15, color: "#111827", background: "#fff", boxSizing: "border-box",
        ...
        {availableBrands.length > 0 && (
          <div style={{ display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap", marginBottom: 24, background: "#fff", padding: "10px 16px", borderRadius: 12, border: "1px solid #e2e8f0" }}>
            <span style={{ fontSize: 13, fontWeight: 700, color: "#64748b" }}>Thương hiệu:</span>
            <button
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(320px, 1fr))", gap: 16, marginBottom: 24 }}>
          {filteredManuals.length > 0 ? (
              ...
              return (
                <div 
                  ...
                  style={{ 
                    ...
                    cursor: "pointer", boxShadow: "0 2px 5px rgba(0,0,0,0.03)", textAlign: "left", transition: "all 0.2s"
                  }}
                ...
                >
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 10 }}>
                    ...
                    <span style={{ fontSize: 12, background: "#f1f5f9", color: "#334155", padding: "2px 8px", borderRadius: 4, fontWeight: 700 }}>
                      {item.brand}
                    </span>
                    <span style={{ fontSize: 12, background: "#e0f2fe", color: "#0369a1", padding: "2px 8px", borderRadius: 4, fontWeight: 700 }}>
                      {cat?.name}
                    </span>
                  </div>
                  ...
                  <div style={{ marginBottom: 8 }}>
                    <span style={{ fontSize: 11, color: "#64748b", fontWeight: 700, display: "block" }}>MÃ MODEL:</span>
                    <span style={{ fontSize: 18, color: "#0284c7", fontWeight: 800 }}>{item.model}</span>
                  </div>

                  {/* Tên Sách HDSD */}
                  <p style={{ margin: "0 0 12px", fontSize: 14, color: "#334155", fontWeight: 500, lineHeight: 1.4 }}>
                    {item.title}
                  </p>
            ...
            <div style={{ gridColumn: "1 / -1", padding: 40, textAlign: "center", background: "#fff", borderRadius: 12, color: "#64748b" }}>
              ❌ Không tìm thấy sách HDSD cho Model này!
            </div>
          )}
        </div>

        {/* KHUNG HIỂN THỊ FILE PDF KHI BẤM VÀO THẺ MODEL */}
        {selectedPdf && (
          <div style={{ background: "#fff", borderRadius: 16, padding: 20, boxShadow: "0 4px 12px rgba(0,0,0,0.08)", border: "1px solid #cbd5e1" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
              <div>
                <h2 style={{ margin: 0, fontSize: 18, color: "#0f172a" }}>
                  📄 Model: <span style={{ color: "#0284c7" }}>{selectedPdf.model}</span> - {selectedPdf.brand}
                </h2>
              ...
              <a 
                href={selectedPdf.pdfUrl} target="_blank" rel="noreferrer"
                style={{ color: "#0284c7", fontSize: 14, fontWeight: 600, textDecoration: "none" }}
              >
                ↗ Mở tab riêng / Tải về
              </a>
            </div>
            ...
            <iframe 
              ...
              style={{ width: "100%", height: "650px", border: "none", borderRadius: 8 }}
            />
          </div>
        )}
