...
export const washingRepairErrors: RepairErrorItem[] = [
  {
    ...
    checkPoints: [
      {
        ...
        spec: "Vị trí van trên PCB (CN9: Trắng, Cam) | Điện áp cấp: 220VAC | Trị số cuộn dây: 10kΩ - 15kΩ",
            images: ["https://lh3.googleusercontent.com/d/17SPX_muDKTmUrFQ7RF4wYFMRw-l5PV5m",
        ...
        spec: "Vị trí van trên PCB (CN2: Cam, Xanh biển, Vàng) | Điện áp cấp: 5VDC | Trị số cuộn dây: 24kΩ - 28kΩ | Điện dung: C= 40 - 50nF",
            images: ["https://lh3.googleusercontent.com/d/13j2umxBtR7LngMY7rmKadXVpg6Goo5vW",
    ...
    steps: [
      {
        title: "Bước 1: Kiểm tra áp lực nước và ống cấp nước (Áp lực nước tiêu chuẩn: 0.1 - 0.4MPa)",
        subSteps: [
          {
